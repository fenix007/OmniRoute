...
export const codexProvider: RegistryEntry = {
  ...
  models: [
    ...
    { id: "gpt-6-sol-high", name: "GPT 6 sol-high", ...GPT_5_6_CODEX_CAPABILITIES },
    { id: "gpt-6-sol-xhigh", name: "GPT 6 sol-xhigh", ...GPT_5_6_CODEX_CAPABILITIES },
    ...
    { id: "gpt-6-luna-high", name: "GPT 6 luna-high", ...GPT_5_6_CODEX_CAPABILITIES },
    { id: "gpt-6-luna-xhigh", name: "GPT 6 luna-xhigh", ...GPT_5_6_CODEX_CAPABILITIES },
